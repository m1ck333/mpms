...
namespace AlGreenMES.Modules.Orders.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260629092644_AddProcessedActions")]
    partial class AddProcessedActions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlGreenMES.Modules.Orders.Domain.Entities.OrderItemProcess", b =>
                {
                    ...
                    b.Property<DateTime?>("PausedOnLogoutAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("paused_on_logout_at");
            ...
            modelBuilder.Entity("AlGreenMES.Modules.Orders.Domain.Entities.ProcessedAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_processed_actions");

                    b.HasIndex("ActionId")
                        .IsUnique()
                        .HasDatabaseName("ix_processed_actions_action_id");

                    b.ToTable("processed_actions", "orders");
                });
